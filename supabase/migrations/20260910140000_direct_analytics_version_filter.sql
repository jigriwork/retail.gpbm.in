-- Read the active-version column directly. Serializing the complete report
-- (including recovery summaries) for every joined row exhausts the RPC budget.
-- is_current has been NOT NULL since migration 20260909102000.
begin;
